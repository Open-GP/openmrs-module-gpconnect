...
public enum TreatmentCategory {
	ONE("1", "Exempt from payment - subject to reciprocal health agreement"), TWO("2", "Exempt from payment - other"), THREE(
	        "3", "To pay hotel fees only"), FOUR("4", "To pay all fees"), EIGHT("8", "Not applicable"), NINE("9",
