...
public enum DeathNotificationStatus {
    ONE("1", "Informal - death notice received via an update from a local NHS Organisation such as GP or Trust"),
    TWO("2","Formal - death notice received from Registrar of Deaths");
